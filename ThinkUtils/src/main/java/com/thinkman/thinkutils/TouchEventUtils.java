...
public class TouchEventUtils {
    ...
    public interface OnEventFinish {
    ...
    public static void dispatchClieckEvent(final View view, final int nX, final int nY, final int nWidth, final int nHeight) {
        int nRandX = nX + RandomUtils.random(0, nWidth);
        int nRandY = nY + RandomUtils.random(0, nHeight);

        dispatchClieckEvent(view, nRandX, nRandY);
    }
